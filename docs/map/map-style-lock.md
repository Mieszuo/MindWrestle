...
| Asset | Path |
|-------|------|
| Background | `public/map/background.png` |
| Pedestals | `public/map/pedestals/*.png` |
| Decor | `public/map/decor/*.png` |
| Elements | `public/map/elements/*.png` |

After adding files, set flags in [`lib/game/mapAssets.ts`](../../lib/game/mapAssets.ts).
